...
<body>
    <section class="banner">
        <h1>Witamy <?php echo $_SESSION['user']; ?> w restauracji „Wszystkie Smaki” <section class="menulogin"><?php echo '<a href="wyloguj.php"><Button class="przycisk">WYLOGUJ</Button></a>'; ?></section></h1>
    </section>
    <section class="pusty">

    </section>
    <section class="lewy">
        <img src="menu.jpg" width="600" height="350 px" alt="Nasze danie">
    </section>
    <section class="prawy">
